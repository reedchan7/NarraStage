...
type CatalogEnvelope = paths["/api/v2/catalog"]["get"]["responses"][200]["content"]["application/json"];
...
type SupportEnvelope = paths["/api/v2/support"]["get"]["responses"][200]["content"]["application/json"];
...
export async function preflightProviderRequest(request: PreflightRequest): Promise<PreflightEnvelope["data"]> {
